...
Generated for PLAN phase. Reuses thinking phase outputs.
...
PLAN -> architecture.md, constraints.md, pbt.md, risks.md, context.md, tasks.md
    |
DEV -> implements using all above outputs
```
...
| Run workspace          | `openspec/changes/<id>/` | TPD workflow            | Per-phase outputs       |
...
| ---------------------- | ------------------------------------------- | --------------------------------------------------------------------------- |
| handoff.json           | `thinking/handoff.json`           | 5 sub-tasks, 8 hard constraints, 6 soft constraints, success criteria       |
| synthesis.md           | `thinking/synthesis.md`           | Cross-boundary constraint set, dependency table, risk matrix                |
| clarifications.md      | `thinking/clarifications.md`      | 3 user decisions: actionable hooks, migrate tech-rules, layered coexistence |
| boundaries.json        | `thinking/boundaries.json`        | 4 context boundaries defined                                                |
| conclusion.md          | `thinking/conclusion.md`          | 7-step reasoning chain, confidence analysis, assumption risks               |
| complexity-analysis.md | `thinking/complexity-analysis.md` | Complexity score 7.3/10, recommended depth: ultra                           |
