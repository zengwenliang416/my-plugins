...
**必须遵守：**
- ✅ 使用 gemini-cli 读取并分析图片
- ✅ 进行至少 3 轮 Gemini-Claude 讨论
- ✅ 提取完整的设计元素
- ✅ 生成结构化分析文档
...
### Step 2: 🚨 第一轮 Gemini 分析（整体风格 + 布局）

**必须调用 gemini-cli**，不可跳过：
...
**记录 Gemini 回答**：保存到变量 `gemini_round1`
