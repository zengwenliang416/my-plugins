...
3. **Summary to User**
   Output:
   - Location of run directory: `.claude/runs/${RUN_ID}/`
...
Run Directory: .claude/runs/tdd-20260208-143022/
...
Run Directory: .claude/runs/tdd-20260208-151543/
